...
export async function summarizeText(text) {
  ...
  const prompt = `Summarize the document briefly (3-5 sentences).if The provided text is insufficient to summarize or meaningless then give any related information and don't give sentences like you don't know or the content is meaningless or something.\n\nDOC:\n${text}`;
